...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        globalHashrate = new QLabel(tab_info);
        globalHashrate->setObjectName(QString::fromUtf8("globalHashrate"));
        globalHashrate->setCursor(QCursor(Qt::IBeamCursor));
        globalHashrate->setTextFormat(Qt::PlainText);
        globalHashrate->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout->addWidget(globalHashrate, 13, 1, 1, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "FuMPcoin - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "FuMPcoin Core", 0, QApplication::UnicodeUTF8));
        ...
        label_15->setText(QApplication::translate("RPCConsole", "Global hashrate", 0, QApplication::UnicodeUTF8));
        globalHashrate->setText(QApplication::translate("RPCConsole", "N/A", 0, QApplication::UnicodeUTF8));
        labelDebugLogfile->setText(QApplication::translate("RPCConsole", "Debug log file", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the FuMPcoin debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the FuMPcoin-Qt help message to get a list with possible FuMPcoin command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
